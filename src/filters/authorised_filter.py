...
class GetBrandAssociatedWithCognitoUser:
    def __init__(self, load_brand_by_auth_id, data_manager: DataManagerInterface):
        self.load_brand_by_auth_id = load_brand_by_auth_id
