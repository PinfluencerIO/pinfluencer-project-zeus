...
class TestBrandController(TestCase):
    ...
    def test_handle_get_by_id(self):
        ...
        pinfluencer_response = self.__sut.get_by_id({'pathParameters': {'brand_id': brand.id}})
    ...
    def test_handle_get_by_id_when_brand_not_found(self):
        ...
        pinfluencer_response = self.__sut.get_by_id({'pathParameters': {'brand_id': field}})
    ...
    def test_handle_get_brand(self):
        ...
        auth_id = "1234brand1"
        response = self.__sut.get({"requestContext": {"authorizer": {"jwt": {"claims":{"cognito:username": auth_id}}}}})
