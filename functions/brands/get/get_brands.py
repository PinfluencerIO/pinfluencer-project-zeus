    ...
    try:
        ...
        try:
            ...
            for brand in body:
                ...
                result = db.executeQuery(selectQuery, [{'name':'brand_id', 'value':{'stringValue': brand["id"]}}], DB_PARAMS)
            ...
            id = event['queryStringParameters']['id']
            if(id == "me"):
                auth_user_id = (json.loads(base64.b64decode(event['headers']['authorization'].split(" ")[1].split(".")[1]+"===")))['cognito:username']
